package userdefinedmethodexample2;
...
public class MethodExample {
	...
	public static void main(String[] args) {
		...
		m2.addition();
		m2.subtraction();// this method  can be accessed in the same  class in which it is created
		// this method can be  access for any number of times  in the same class
		// private method  cannot be accessed  in any other  different  java class
	}
